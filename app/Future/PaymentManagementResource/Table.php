...
use App\Future\PaymentManagementResource\Modal\AccpectPayment;
...
class Table extends BaseTable
{
    ...
    {
        return parent::query()->whereIn('status', ['accepted', 'pending', 'returned'])->with(["user", "post"]); // TODO: Change the autogenerated stub
    }
        ...
        return [
            ...
            TextColumn::make('status', __('Trạng thái'))->badge(
                ...
                [
                    ...
                    'cancel' => __('Huỷ'),
                    'shop_cancellation' => __('Từ chối'),
                    'user_cancellation' => __('Từ chối'),
                    'waiting_for_payment' => __('Đợi thanh toán'),
                    'delivered_successfully' => __('Giao hàng xong'),
                    'delivery_in_progress' => __('Đang giao hàng'),
                    'retry_delivery' => __('Giao hàng lại'),
                    'pick_failed' => __('Không lấy được hàng'),
                    'picking' => __('Đang lấy hàng'),
                    'picked' => __('Đã lấy hàng'),
                ]
            )
        ];
    }
    ...
    protected function actions(Actions $actions): Actions
    {
        return $actions->create(
            [
                Action::make('updateStatus', __('Xác nhận thanh toán'), 'fas fa-edit')->modal(AccpectPayment::class, 'edit'),
